...
},{"./bullet":1,"./burst":2,"./elementlist":5,"./health":7,"./main":9,"./randomwalkcircleelement":10,"./regenerateBoss":11,"./spawnerboss":12,"./stage":13,"./validator":14,"./word":15,"./wordinputhandler":16}],7:[function(require,module,exports){
...
module.exports = class Stage extends Element {
    ...
    draw(ctx) {
        ...
        ctx.drawImage(
            this.background,0,0,canvas.width,canvas.height)
    }
}
